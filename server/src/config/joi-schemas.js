...
export const userSchema = Joi.object({
	userName: Joi.string().trim().min(USERNAME_MIN_LEN).max(USERNAME_MAX_LEN).required().messages({
	...
	userEmail: Joi.string().email().trim().max(USER_EMAIL_MAX_LEN).required().messages({
